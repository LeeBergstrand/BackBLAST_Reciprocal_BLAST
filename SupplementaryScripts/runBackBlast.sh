...
do
	...
	python -u ../BackBLAST.py ../ExampleData/ExampleQueries/CommamonasCluster.faa ../ExampleData/ExampleQueryProteomes/CP001220.1.faa $fasta 2>&1 | tee -a "BackLog$timestamp.txt"
